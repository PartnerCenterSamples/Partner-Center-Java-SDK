// -----------------------------------------------------------------------
// <copyright file="GetSortedCustomerUsers.java" company="Microsoft">
...
public class GetSortedCustomerUsers extends BasePartnerScenario {

	public GetSortedCustomerUsers(IScenarioContext context) {
