// -----------------------------------------------------------------------
// <copyright file="GetCustomerUsers.java" company="Microsoft">
...
public class GetCustomerUsers extends BasePartnerScenario {

	public GetCustomerUsers(IScenarioContext context) {
