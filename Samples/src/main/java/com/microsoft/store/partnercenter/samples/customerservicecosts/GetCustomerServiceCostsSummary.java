...
public class GetCustomerServiceCostsSummary extends BasePartnerScenario 
{
    ...
    protected void runScenario() 
    {
        ...
        ServiceCostsSummary customerServiceCostsSummary = partnerOperations.getCustomers().byId(customerId).getServiceCosts().byBillingPeriod(ServiceCostsBillingPeriod.MostRecent).getSummary().get();
