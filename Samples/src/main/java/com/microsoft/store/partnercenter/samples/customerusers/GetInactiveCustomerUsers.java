// -----------------------------------------------------------------------
// <copyright file="GetInactiveCustomerUsers.java" company="Microsoft">
...
public class GetInactiveCustomerUsers extends BasePartnerScenario {

	public GetInactiveCustomerUsers(IScenarioContext context) {
	...
	protected void runScenario() {
        ...
        while ( customerUsersEnumerator.hasValue() )
        {
            ...
            for ( CustomerUser user : customerUsersEnumerator.getCurrent().getItems() )
            {
                ...
                System.out.println( "Company User State: " + user.getUserState() );
                System.out.println();
            }
