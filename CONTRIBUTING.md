# Contributing to the Partner Center Java SDK
...
You can file new issues by providing the above information at the [corresponding repository's issues link](https://github.com/PartnerCenterSamples/Partner-Center-Java-SDK/issues/new).

### Submitting a Pull Request

Before you submit your Pull Request (PR) consider the following guidelines:

- [Search the repository](https://github.com/PartnerCenterSamples/Partner-Center-Java-SDK/pulls) for an open or closed PR
